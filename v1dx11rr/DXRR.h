...
public:	
	...
	void Render(void)
	{
		...
		pilarRoca1->Draw(playerCamera->vista, playerCamera->proyeccion, terreno->Superficie(AntModel_Rigged_Smooth->getPosX(), AntModel_Rigged_Smooth->getPosZ()), player->GetPosition(), 10.0f, 0, 'A', 1);
